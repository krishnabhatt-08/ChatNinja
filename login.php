...
if(isset($_POST["name"]) && isset($_POST["phone"])){
    ...
    if($rq=mysqli_query($db,$q)){
       ...
       // Check if the username or the phone number field is empty
      if ($name === "" || $phone === "") {
        echo "<script>alert(' Please Fill the Fields')</script>";
      }

      else if(mysqli_num_rows($rq)==1){
...
<body>
  ...
  <div class="login">
    ...
    <form action="" method="post">
      ...
      <h3>Mobile No</h3>
      <input type="number" placeholder="with country code" min="
      1111111" max="999999999999999" name="phone">
